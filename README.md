...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-rpivottable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rpivottable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-rpivottable
# for installing globally
pixi global install r-rpivottable
```
...
It is possible to list all of the versions of `r-rpivottable` available on your platform:
...
```
pixi search r-rpivottable --channel conda-forge
```
